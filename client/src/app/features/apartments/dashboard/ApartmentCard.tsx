...
export default function ApartmentCard({ apartment }: Props) {
    ...
    return (
        <div className="card bg-base-50 w-auto shadow-lg">
            ...
            <div className="card-body p-2">
                ...
                <h2 className="card-title text-sm">{apartment.area} m&sup2;</h2>
                <h2 className="card-title text-sm">Number of rooms: {apartment.rooms} </h2>
